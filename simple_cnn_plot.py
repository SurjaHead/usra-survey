#!/usr/bin/env python3
"""
Simple CNN timing plotter using only matplotlib and built-in libraries.
"""
...
def load_cnn_data(data_dir="cnn_data"):
    """Load CNN timing data from CSV files"""
    all_data = {}
...
def create_plot(data):
    ...
    plt.title('CNN (ResNet-18) Activation Function Performance', fontsize=16, fontweight='bold', pad=20)
    ...
    # Save plot
    plt.savefig('cnn_activation_timing.png', dpi=300, bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    plt.savefig('cnn_activation_timing.pdf', bbox_inches='tight', 
                facecolor='white', edgecolor='none')
    
    print("📊 Plot saved as cnn_activation_timing.png and .pdf")
    plt.show()

def print_summary(data):
    """Print summary statistics"""
    print("\n" + "="*60)
    print("📊 CNN (ResNet-18) ACTIVATION FUNCTION PERFORMANCE SUMMARY")
    print("="*60)
...
def main():
    print("🚀 Simple CNN Activation Timing Plotter")
    print("=" * 50)
    
    # Load data
    data = load_cnn_data("cnn_data")
    
    if not data:
        print("❌ No data found. Make sure cnn_data/ directory exists with CSV files.")
        print("💡 Run one of these first:")
        print("   python download_cnn_data.py")
        print("   python download_all_cnn_data.py")
        return
    ...
    print("   - cnn_activation_timing.png")
    print("   - cnn_activation_timing.pdf")
